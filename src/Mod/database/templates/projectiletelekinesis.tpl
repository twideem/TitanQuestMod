Group
{
	...
	Group
	{
		...
		Variable
		{
			...
			description = ""
			value = ""
			defaultValue = "ProjectileTelekinesis"
		}
	...
	Group
	{
		name = "Projectile Telekinesis Effects"
		type = "list"
...
{
	"Templates\Copy of ProjectileFireballLike.tpl"
}
